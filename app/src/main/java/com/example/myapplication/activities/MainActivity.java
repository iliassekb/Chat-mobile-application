...
import com.example.myapplication.utilities.PrefernceManager;
...
public class MainActivity extends AppCompatActivity implements ConversionListener {
    ...
    private void listenConversations(){
        database.collection(Constants.KEY_COLLECTION_CONVERSATIONS)
                ...
                .addSnapshotListener(eventListene);
        database.collection(Constants.KEY_COLLECTION_CONVERSATIONS)
                .whereEqualTo(Constants.KEY_RECEIVER_ID,prefernceManager.getString(Constants.KEY_USER_ID))
                .addSnapshotListener(eventListene);
    }
    private final EventListener<QuerySnapshot> eventListene = (value,error)->{
        if(error != null){
            return;
        }
        if(value != null){
